...
class FractionInitTest(unittest.TestCase):
    def test_den_null(self):
        ...
        self.assertRaises(ZeroDivisionError, fraction.Fraction, *[1, 0])


my_fraction = fraction.Fraction(1, 3)
...
class FractionIsZeroTest(unittest.TestCase):
    def test_fraction_positive(self):
        ...
        self.assertEqual(fraction.Fraction(1, 8).is_zero(), False, "fraction.Fraction(1,8).is_zero()")
        self.assertEqual(fraction.Fraction(14, 8).is_zero(), False, "fraction.Fraction(14,8).is_zero()")

    def test_fraction_null(self):
        """Vérification de si une fraction nulle est = 0"""
        self.assertEqual(fraction.Fraction(0, 8).is_zero(), True, "fraction.Fraction(0, 8).is_zero()")

    def test_fraction_negative(self):
        """Vérification de si une fraction negative est = 0"""
        self.assertEqual(fraction.Fraction(-3, 8).is_zero(), False, "fraction.Fraction(-3, 8).is_zero()")
        self.assertEqual(fraction.Fraction(-20, 8).is_zero(), False, "fraction.Fraction(-20, 8).is_zero()")


class FractionIsIntegerTest(unittest.TestCase):
    def test_fraction_positive(self):
        """Vérification de si une fraction positive est = 0"""
        self.assertEqual(fraction.Fraction(1, 8).is_integer(), False, "fraction.Fraction(1, 8).is_integer()")
        self.assertEqual(fraction.Fraction(14, 7).is_integer(), True, "fraction.Fraction(14, 7).is_integer()")

    def test_fraction_null(self):
        """Vérification de si une fraction nulle est = 0"""
        self.assertEqual(fraction.Fraction(0, 8).is_integer(), True, "fraction.Fraction(0, 8).is_integer()")

    def test_fraction_negative(self):
        """Vérification de si une fraction negative est = 0"""
        self.assertEqual(fraction.Fraction(-3, 8).is_integer(), False, "fraction.Fraction(-3, 8).is_integer()")
        self.assertEqual(fraction.Fraction(-24, 8).is_integer(), True, "fraction.Fraction(-24, 8).is_integer()")


class FractionIsProperTest(unittest.TestCase):
    def test_fraction_positive(self):
        """Vérification de si la valeur absolue d'une fraction positive est < 1"""
        self.assertEqual(fraction.Fraction(1, 8).is_proper(), True, "fraction.Fraction(1, 8).is_proper()")
        self.assertEqual(fraction.Fraction(14, 7).is_proper(), False, "fraction.Fraction(14, 7).is_proper()")

    def test_fraction_null(self):
        """Vérification de si la valeur absolue d'une fraction nulle est < 1"""
        self.assertEqual(fraction.Fraction(0, 8).is_proper(), True, "fraction.Fraction(0, 8).is_proper()")

    def test_fraction_negative(self):
        """Vérification de si la valeur absolue d'une fraction negative est < 1"""
        self.assertEqual(fraction.Fraction(-3, 8).is_proper(), True, "fraction.Fraction(-3, 8).is_proper()")
        self.assertEqual(fraction.Fraction(-24, 8).is_proper(), False, "fraction.Fraction(-24, 8).is_proper()")


class FractionIsUnitTest(unittest.TestCase):
    def test_fraction_positive(self):
        """Vérification de si le numerateur = 1 quand la fraction positive est simplifiée"""
        self.assertEqual(fraction.Fraction(4, 8).is_unit(), True, "fraction.Fraction(4, 8).is_unit()")
        self.assertEqual(fraction.Fraction(14, 7).is_unit(), False, "fraction.Fraction(14, 7).is_unit()")

    def test_fraction_null(self):
        """Vérification de si le numerateur = 1 quand la fraction nulle est simplifiée"""
        self.assertEqual(fraction.Fraction(0, 8).is_unit(), False, "fraction.Fraction(0, 8).is_unit()")

    def test_fraction_negative(self):
        """Vérification de si le numerateur = 1 quand la fraction négative est simplifiée"""
        self.assertEqual(fraction.Fraction(-3, 8).is_unit(), False, "fraction.Fraction(-3, 8).is_unit()")
        self.assertEqual(fraction.Fraction(-24, 8).is_unit(), False, "fraction.Fraction(-24, 8).is_unit()")
